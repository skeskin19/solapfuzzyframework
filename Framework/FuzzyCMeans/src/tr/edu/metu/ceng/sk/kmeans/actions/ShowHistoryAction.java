...
public class ShowHistoryAction extends KMeansAbstractAction {

    private static final String ACTION_COMMAND_KEY_ABOUT = "show-history-command";
    private static final String NAME_ABOUT = "Show history";
    private static final String SMALL_ICON_ABOUT = null;
    private static final String LARGE_ICON_ABOUT = null;
    private static final String SHORT_DESCRIPTION_ABOUT = "Show history";
    private static final String LONG_DESCRIPTION_ABOUT = "Show history";
