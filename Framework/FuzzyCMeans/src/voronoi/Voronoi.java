...
public class Voronoi {
    ...
    /** generate the kc.test.kmeans.Voronoi diagram */
    ...
    /** merges two adjacent exclusive kc.test.kmeans.Voronoi diagrams */
    ...
    /** get all intersects */
    private static VList getAllIntersects(final Segment l, final Segment s) {
        VList intersects = new VList();
    ...
    /** find first point */
    private static CompoundLine findFirstPoint(Segment line, final VList intersects, final Segment s) {
        CompoundLine m;
    ...
    /** find next point */
    private static CompoundLine findNextPoint(Segment line, final VList intersects, final Segment s) {
        CompoundLine m;
        Enumeration i = intersects.elements();
        if(!i.hasMoreElements())
            return null;
