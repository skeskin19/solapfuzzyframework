...
public class TrainTestSplitCrisp {
	
	public static String allDataFile = "met-data-all-02052020-for-association.txt";
	public static String testIdFile = "test-split-data-id.txt";
	
	public static String trainDataFile = "met-data-train-02052020-for-association.txt";
	public static String testDataFile = "met-data-test-02052020-for-association.txt";
