...
public class MeteorologyFuzzyInferenceSystem4_actual_pressure {
	private static final String FILE_NAME = "meteorological-data-actual-pressure.csv";
	private static final String COMMA_DELIMITER = ",";

	public static void main(String[] args) throws Exception {
		long startTime = System.currentTimeMillis();
		
		DataHolder.fillActualPressureDataMap2();
		...
		for(MetDataBean mb:records) {
			...
			System.out.println(mb.getDay()+"-"+mb.getMonth()+"-"+mb.getYear()+"\t"+mb.getActual_2016()+"\t"+predictedDefuzzifiedData+"\t"+randomForestPrediction+"\t"+diff+"\t"+ratio);
