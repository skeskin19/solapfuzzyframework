...
public class MeteorologyClass_v3_windspeed {
	public static void main(String[] args) throws Exception {
		...
		// Set inputs
		fb.setVariable("actual_pressure_in", 948);
		fb.setVariable("temperature_in", 15);
		...
		fb.getVariable("wind_speed_out").defuzzify();

		Variable predictedHot = fb.getVariable("wind_speed_out");
		// Print ruleSet
		...
		System.out.println("extreme_out-membership: " + predictedHot.getMembership("extreme_out"));
