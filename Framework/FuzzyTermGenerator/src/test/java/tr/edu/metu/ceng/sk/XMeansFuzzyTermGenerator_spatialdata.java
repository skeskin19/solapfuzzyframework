...
public class XMeansFuzzyTermGenerator_spatialdata {
	
	//private String FILE_NAME = "actual_pressure2.txt";//"cloudiness.txt"; //"rainfall.txt";//"relative_humidity.txt";//"sunshine_hour.txt";//"temperature.txt";//"vapor_pressure.txt";//"wind_speed.txt";
	//private String MET_TYPE = "actual_pressure";//"cloudiness["; //"rainfall[";//"relative-humidity[";//"sunshine-hour[";//"vapor-pressure[";//"wind-speed["; 
    ...
    private static Logger _logger = Logger.getLogger(XMeansFuzzyTermGenerator_spatialdata.class);
    ...
    public void faithful() throws Exception {
    	...
    	String[] clusterLabelsActualPressure={"low", "high", "extreme", "very-high", "very-low", "normal"};//actual_pressure
    	...
    	String[] clusterLabelsHumidity={"very-low", "nearly-dry", "flood", "normal", "overmuch", "very-high", "low", "high"};//relative_humidity
    	...
    	String[] clusterLabelsLatitude={"center-s", "south", "north", "center-n"};//latitude
    	String[] clusterLabelsLongitude={"west", "center-w", "east", "center-e"};//longitude
    	
    	
    	String[] clusterLabelsAltitude={"sea-level", "high", "peak", "normal"};//altitude
    	
    	printFclHeader();
    	
    	
//    	executeXMeans("actual_pressure2.txt", "actual_pressure", clusterLabelsActualPressure);
...
//    	executeXMeans("relative_humidity2.txt", "relative_humidity", clusterLabelsHumidity);
//    	executeXMeans("sunshine_hour2.txt", "sunshine_hour", clusterLabelsSunShine);
//    	executeXMeans("temperature2.txt", "temperature", clusterLabelsTemperature);
...
//    	executeXMeans("latitude3.txt", "latitude", clusterLabelsLatitude);
//    	executeXMeans("longitude3.txt", "longitude", clusterLabelsLongitude);
    	executeXMeans("altitude3.txt", "altitude", clusterLabelsAltitude);
