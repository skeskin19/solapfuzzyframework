...
public class XMeansFuzzyTermGenerator_wind_speed {
    ...
    private static Logger _logger = Logger.getLogger(XMeansFuzzyTermGenerator_wind_speed.class);
    ...
    public void faithful() throws Exception {
    	...
    	String[] clusterLabelsCloudiness={"Partly-Sunny", "Overcast", "Partly-Cloudy", "Sunny"};//{"Mostly-Cloudy", "Partly-Sunny", "Partly-Cloudy", "Mostly-Sunny", "Overcast", "Broken", "Sunny", "Fair"};//cloudiness
    	String[] clusterLabelsRainfall={"overmuch", "nearly-dry", "very-high", "very-low", "low", "flood", "high", "normal"};//rainfall
    	...
    	String[] clusterLabelsSunShine={"normal", "high", "low", "luminous"};//{"normal", "high", "dark", "overmuch", "luminous", "very-high", "low", "nearly-dark"};//sunshine_hour
    	...
    	String[] clusterLabelsVaporPressure={"normal", "high", "extreme", "low"};//{"above-normal", "extreme", "high", "very-low", "normal","below-normal","very-high","low"};//vapor_pressure
    	String[] clusterLabelsWindSpeed={"low", "high", "extreme", "normal"};//wind_speed
...
//    	executeXMeans("cloudiness3.txt", "cloudiness", clusterLabelsCloudiness);
//    	executeXMeans("rainfall3.txt", "rainfall", clusterLabelsRainfall);
//    	executeXMeans("relative_humidity3.txt", "relative_humidity", clusterLabelsHumidity);
//    	executeXMeans("sunshine_hour3.txt", "sunshine_hour", clusterLabelsSunShine);
//    	executeXMeans("temperature3.txt", "temperature", clusterLabelsTemperature);
//    	executeXMeans("vapor_pressure3.txt", "vapor_pressure", clusterLabelsVaporPressure);
   	executeXMeans("wind_speed3.txt", "wind_speed", clusterLabelsWindSpeed);
