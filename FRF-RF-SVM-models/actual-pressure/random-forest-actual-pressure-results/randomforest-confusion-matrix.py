...
labelsT = np.array(features['actual_pressure'])
...
cluster_names = ["very-low", "low", "normal", "high", "very-high", "huge"]

featuresT = features.drop('actual_pressure', axis = 1)
...
a= label_binarize(y_test, classes=[0, 1, 2, 3, 4, 5])
b= label_binarize(predictions, classes=[0, 1, 2, 3, 4, 5])
