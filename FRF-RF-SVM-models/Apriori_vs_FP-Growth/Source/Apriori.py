                    ...
                    if((ant[len(j)][j]/ant[l][n])>=minconf):
                        ...
                        if(closed.__contains__((n))):
                            ...
                            if(len(r)==1):
                                ...
                                #print("IF ", parsePredication(n, '_in'), " THEN ", parsePredication(r2, '_out'), "(",ant[len(r)][r2],")", " confidence = ",(ant[len(j)][j]/ant[l][n]))
                            else:
                                print(n,"(",ant[l][n],")","--->",r,"(",ant[len(r)][r],")", " confidence = ",(ant[len(j)][j]/ant[l][n]))
                                #for ind in range(0,len(r)):
                                #    print("IF ", parsePredication(n, '_in'), " THEN ", parsePredication(r[ind], '_out'), "(",ant[len(r)][r],")", " confidence = ",(ant[len(j)][j]/ant[l][n]))
