...
labelsT = np.array(features['relative_humidity'])
...
cluster_names = ["less", "normal", "high", "extreme"]

featuresT = features.drop('relative_humidity', axis = 1)
...
model = svm.SVC(kernel='linear', C=0.1, cache_size=800, verbose=True)
classifier = model.fit(X_train, y_train)

print('memory status at SVM fit: ', psutil.virtual_memory())
...
print('memory status at variable importance: ', psutil.virtual_memory())
